...
const packs: Pack[] = [
  ...
  },
  {
    ...
    image: 'https://media.istockphoto.com/id/1266092627/photo/spicy-fish-curry-popular-indian-seafood-served-with-rice.webp?a=1&b=1&s=612x612&w=0&k=20&c=o-SqeoPvD_mFM8DwQ_TDHVcQePiFOpuZQ2PC45dbRMs=',
    category: 'dish_pack',
    price: 90,
    serves: '3-4 people',
    color: '#E3F2FD',
  ...
  // ─── Salad Packs ───
  {
    ...
    image: 'https://images.unsplash.com/photo-1605291535126-2d71fea483c1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2FyZGVuJTIwc2FsYWR8ZW58MHx8MHx8fDA%3D',
    category: 'salad_pack',
    price: 75,
    serves: '2-3 people',
    color: '#E8F5E9',
